...
These predictions need to now be used to determine the expected state mean as well as the expected error. The expected mean and error are calculated as follows 
